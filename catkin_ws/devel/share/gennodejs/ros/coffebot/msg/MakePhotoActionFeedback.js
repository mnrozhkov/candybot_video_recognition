...
class MakePhotoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MakePhotoFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MakePhotoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MakePhotoActionFeedback(null);
    ...
    data.feedback = MakePhotoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MakePhotoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MakePhotoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MakePhotoFeedback()
    }
...
module.exports = MakePhotoActionFeedback;
