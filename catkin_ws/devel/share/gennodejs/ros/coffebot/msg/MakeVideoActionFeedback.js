...
class MakeVideoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MakeVideoFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MakeVideoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MakeVideoActionFeedback(null);
    ...
    data.feedback = MakeVideoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MakeVideoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MakeVideoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MakeVideoFeedback()
    }
...
module.exports = MakeVideoActionFeedback;
