...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/alex/catkin_ws/src/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/alex/catkin_ws/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/alex/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/catkin_ws/src/nmea_navsat_driver/${idir}'.  Ask the maintainer 'Eric Perko <eric@ericperko.com>' to fix it.")
    endif()
