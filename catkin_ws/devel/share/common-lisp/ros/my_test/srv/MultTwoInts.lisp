...
(cl:defmethod cl:initialize-instance :after ((m <MultTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_test-srv:<MultTwoInts-request> is deprecated: use my_test-srv:MultTwoInts-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MultTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_test-srv:<MultTwoInts-response> is deprecated: use my_test-srv:MultTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <MultTwoInts-response>))
