...
"""autogenerated by genpy from coffebot/MakePhotoActionFeedback.msg. Do not edit."""
import sys
...
class MakePhotoActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "coffebot/MakePhotoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','coffebot/MakePhotoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakePhotoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = coffebot.msg.MakePhotoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = coffebot.msg.MakePhotoFeedback()
