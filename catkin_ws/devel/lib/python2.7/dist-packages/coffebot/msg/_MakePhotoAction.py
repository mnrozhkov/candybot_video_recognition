...
"""autogenerated by genpy from coffebot/MakePhotoAction.msg. Do not edit."""
import sys
...
class MakePhotoAction(genpy.Message):
  _md5sum = "ab3d13faf6144e0df8eff95516064535"
  _type = "coffebot/MakePhotoAction"
...
"""
  ...
  _slot_types = ['coffebot/MakePhotoActionGoal','coffebot/MakePhotoActionResult','coffebot/MakePhotoActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakePhotoAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = coffebot.msg.MakePhotoActionGoal()
      if self.action_result is None:
        self.action_result = coffebot.msg.MakePhotoActionResult()
      if self.action_feedback is None:
        self.action_feedback = coffebot.msg.MakePhotoActionFeedback()
    else:
      self.action_goal = coffebot.msg.MakePhotoActionGoal()
      self.action_result = coffebot.msg.MakePhotoActionResult()
      self.action_feedback = coffebot.msg.MakePhotoActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_goal.goal.make_photo_command.make_photo))
      _x = self.action_goal.goal.make_photo_command.photo_file_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.make_photo_command.make_photo,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.make_photo_command.make_photo = bool(self.action_goal.goal.make_photo_command.make_photo)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.make_photo_command.photo_file_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.make_photo_command.photo_file_name = str[start:end]
      _x = self
      start = end
      end += 12
