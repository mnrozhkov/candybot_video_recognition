...
"""autogenerated by genpy from coffebot/MakePhotoActionResult.msg. Do not edit."""
import sys
...
class MakePhotoActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "coffebot/MakePhotoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','coffebot/MakePhotoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakePhotoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = coffebot.msg.MakePhotoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = coffebot.msg.MakePhotoResult()
