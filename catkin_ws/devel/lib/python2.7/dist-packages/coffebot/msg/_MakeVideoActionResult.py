...
"""autogenerated by genpy from coffebot/MakeVideoActionResult.msg. Do not edit."""
import sys
...
class MakeVideoActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "coffebot/MakeVideoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','coffebot/MakeVideoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakeVideoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = coffebot.msg.MakeVideoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = coffebot.msg.MakeVideoResult()
