...
class MakeVideoAction(genpy.Message):
  _md5sum = "1658521515f941ea3bb37f547f7378cb"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bb().pack(_x.action_goal.goal.make_video_command.start_video, _x.action_goal.goal.make_video_command.duration))
      _x = self.action_goal.goal.make_video_command.video_file_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.make_video_command.start_video, _x.action_goal.goal.make_video_command.duration,) = _get_struct_Bb().unpack(str[start:end])
      self.action_goal.goal.make_video_command.start_video = bool(self.action_goal.goal.make_video_command.start_video)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.make_video_command.video_file_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.make_video_command.video_file_name = str[start:end]
      _x = self
      start = end
      end += 12
